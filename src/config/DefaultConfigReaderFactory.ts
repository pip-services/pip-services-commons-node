...
export class DefaultConfigReaderFactory extends Factory {
	public static readonly Descriptor = new Descriptor("pip-services-commons", "factory", "config-reader", "default", "1.0");
	public static readonly MemoryConfigReaderDescriptor = new Descriptor("pip-services-commons", "config-reader", "memory", "*", "1.0");
	public static readonly JsonConfigReaderDescriptor = new Descriptor("pip-services-commons", "config-reader", "json", "*", "1.0");
	public static readonly YamlConfigReaderDescriptor = new Descriptor("pip-services-commons", "config-reader", "yaml", "*", "1.0");
